<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Using_Date.aspx.cs" Inherits="Using_Date" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>year of Passout</title>
    <style type="text/css">
        .style11
        {
            width: 100%;
...
&nbsp;</p>
    <p>
                ...
                <asp:TemplateField HeaderText="ImageOfStudent" SortExpression="ImageOfStudent">
                    ...
                    <ItemTemplate>
                        <asp:Image ID="Image2" runat="server" Height="104px" 
                            ImageUrl='<%# Eval("ImageOfStudent") %>' Width="69px" />
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Student_info.Stu_Name, Student_info.UniversityID, Student_info.College, Student_info.CertificationNo, Student_info.YearOfPassout, Student_Details.Location, Student_Details.State, Student_Details.ContactNo, Student_Details.EmailID, Student_Details.ImageOfStudent FROM Student_Details INNER JOIN Student_info ON Student_Details.StudentID = Student_info.StudentID WHERE (Student_info.YearOfPassout = @yop)">
            <SelectParameters>
                <asp:SessionParameter Name="yop" SessionField="yop" />
            </SelectParameters>
        </asp:SqlDataSource>
    </p>
<p>
